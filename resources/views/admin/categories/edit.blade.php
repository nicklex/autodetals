...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div>
            <a href="{{ route('category.show', $category->code) }}" target="_blank" class="btn btn-info">
    ...
    <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="parent_id" id="parent_id" class="form-select">
                                ...
                                @foreach($categories as $cat)
                                    @if($cat->id != $category->id) <!-- Исключаем текущую категорию из выбора родителя -->
                                        <option value="{{ $cat->id }}" 
                            ...
                            <small class="text-muted">Оставьте пустым для создания корневой категории</small>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <textarea name="meta_description" id="meta_description" 
                                                  class="form-control" rows="2">{{ old('meta_description', $category->meta_description) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card shadow mb-4">
                <div class="card-header">
                    <h5 class="mb-0">Изображение категории</h5>
                </div>
                <div class="card-body">
                    @if($category->image)
                        <div class="text-center mb-3">
                            ...
                            <div class="mt-2">
                                <form action="{{ route('admin.categories.update', $category->id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('PUT')
                    ...
                    <div class="mb-3">
                        <label for="image" class="form-label">
                            {{ $category->image ? 'Заменить изображение' : 'Загрузить изображение' }}
                        </label>
            ...
            <div class="card shadow mb-4">
                <div class="card-header">
                    <h5 class="mb-0">Настройки категории</h5>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input type="checkbox" name="show_in_home" id="show_in_home" 
                                   class="form-check-input" value="1" 
                                   {{ old('show_in_home', $category->show_in_home ?? false) ? 'checked' : '' }}>
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            Подкатегорий
                            <span class="badge bg-success rounded-pill">{{ $category->children_count ?? 0 }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            Создана
            ...
            <div class="card shadow border-danger mt-4">
                ...
                <div class="card-body">
                    <p class="text-muted small mb-3">
                        Удаление категории перенесет все товары в эту категорию в категорию "Без категории".
                    </p>
                    <form action="{{ route('admin.categories.destroy', $category->id) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-danger w-100" 
                                onclick="return confirm('Удалить категорию? Все товары будут перемещены в категорию "Без категории".')">
